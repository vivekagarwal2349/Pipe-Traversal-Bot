...
def post_process(training_name):
	...
	training_logs = pd.read_csv("./Training_Logs/insert_training_name_here_logs.csv", header = 0)
	nn_loss = pd.read_csv("./Training_Logs/insert_training_name_here_NN_loss.csv", header = 0)
